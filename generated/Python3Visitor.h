...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitAddminus(Python3Parser::AddminusContext *context) = 0;

    virtual antlrcpp::Any visitTerm(Python3Parser::TermContext *context) = 0;

    virtual antlrcpp::Any visitMuldivmod(Python3Parser::MuldivmodContext *context) = 0;
