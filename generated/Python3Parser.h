...
public:
  ...
  enum {
    ...
    RuleComp_op = 23, RuleArith_expr = 24, RuleAddminus = 25, RuleTerm = 26, 
    RuleMuldivmod = 27, RuleFactor = 28, RuleAtom_expr = 29, RuleTrailer = 30, 
  ...
  public:
    ...
    std::vector<AddminusContext *> addminus();
    AddminusContext* addminus(size_t i);
  ...
  class  AddminusContext : public antlr4::ParserRuleContext {
  public:
    AddminusContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    std::vector<MuldivmodContext *> muldivmod();
    MuldivmodContext* muldivmod(size_t i);
