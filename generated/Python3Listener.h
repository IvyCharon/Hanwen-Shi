...
public:
  ...
  virtual void enterAddminus(Python3Parser::AddminusContext *ctx) = 0;
  virtual void exitAddminus(Python3Parser::AddminusContext *ctx) = 0;

  virtual void enterTerm(Python3Parser::TermContext *ctx) = 0;
  virtual void exitTerm(Python3Parser::TermContext *ctx) = 0;

  virtual void enterMuldivmod(Python3Parser::MuldivmodContext *ctx) = 0;
  virtual void exitMuldivmod(Python3Parser::MuldivmodContext *ctx) = 0;
